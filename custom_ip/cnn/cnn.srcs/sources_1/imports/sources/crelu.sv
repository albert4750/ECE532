...
//     CReLU activation function, and produces a stream of data. Both the input
//     and output data are treated as two's complement signed numbers.
//
...
module crelu #(
    ...
    register_buffer #(
        .DATA_WIDTH (DATA_WIDTH * IN_CHANNELS * 2),
        .ASYNC_READY(1)
    ) buffer (
        .clock_i(clock_i),
        .reset_i(reset_i),
