...
HD_PWD='/home/yunhao/Documents/ECE532-Digital-Systems-Design/ECE532-main/custom_ip/superresolution/superresolution.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log superresolution.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source superresolution.tcl -notrace
