...
HD_PWD='/home/yunhao/Documents/ECE532-Digital-Systems-Design/ECE532-main/custom_ip/superresolution/superresolution.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log superresolution.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source superresolution.tcl
