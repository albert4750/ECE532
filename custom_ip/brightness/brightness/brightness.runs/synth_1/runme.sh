...
HD_PWD='/home/ece532/ECE532/custom_ip/brightness/brightness/brightness.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log brightening.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source brightening.tcl
