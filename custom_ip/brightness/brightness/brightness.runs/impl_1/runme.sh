...
HD_PWD='/home/ece532/ECE532/custom_ip/brightness/brightness/brightness.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log brightening.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source brightening.tcl -notrace
