...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "BUFFER_WIDTH" -parent ${Page_0}
  ipgui::add_param $IPINST -name "OUT_CTR_MAX" -parent ${Page_0}
  ipgui::add_param $IPINST -name "PIXEL_PER_BUFFER" -parent ${Page_0}
...
proc update_PARAM_VALUE.OUT_CTR_MAX { PARAM_VALUE.OUT_CTR_MAX } {
	# Procedure called to update OUT_CTR_MAX when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.OUT_CTR_MAX { PARAM_VALUE.OUT_CTR_MAX } {
	# Procedure called to validate OUT_CTR_MAX
	return true
}
...
proc update_MODELPARAM_VALUE.OUT_CTR_MAX { MODELPARAM_VALUE.OUT_CTR_MAX PARAM_VALUE.OUT_CTR_MAX } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.OUT_CTR_MAX}] ${MODELPARAM_VALUE.OUT_CTR_MAX}
}
