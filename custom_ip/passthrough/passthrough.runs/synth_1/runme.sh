...
HD_PWD='C:/Users/Albert/Documents/GitHub/ECE532/custom_ip/passthrough/passthrough.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log passthrough.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source passthrough.tcl
