...
HD_PWD='/home/ece532/ECE532/custom_ip/convolve_rgb/convolve_rgb.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log convolve_rgb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source convolve_rgb.tcl
