...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "ADDER_BRANCHING_FACTOR" -parent ${Page_0}
...
proc update_PARAM_VALUE.ADDER_BRANCHING_FACTOR { PARAM_VALUE.ADDER_BRANCHING_FACTOR } {
	# Procedure called to update ADDER_BRANCHING_FACTOR when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.ADDER_BRANCHING_FACTOR { PARAM_VALUE.ADDER_BRANCHING_FACTOR } {
	# Procedure called to validate ADDER_BRANCHING_FACTOR
	return true
}
...
proc update_MODELPARAM_VALUE.ADDER_BRANCHING_FACTOR { MODELPARAM_VALUE.ADDER_BRANCHING_FACTOR PARAM_VALUE.ADDER_BRANCHING_FACTOR } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.ADDER_BRANCHING_FACTOR}] ${MODELPARAM_VALUE.ADDER_BRANCHING_FACTOR}
}
