...
HD_PWD='C:/Users/Albert/Documents/GitHub/ECE532/custom_ip/grayscale_stream/grayscale_stream.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log grayscale_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source grayscale_top.tcl
