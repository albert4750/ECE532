...
// Description: This module accepts a stream of sliding windows, applies a
//     constant 2-D convolution kernel, and produces a stream of reduced sums.
//
//     - Input: Stream of elements, each element of (KERNEL_SIZE, KERNEL_SIZE,
//       ACTIVATION_WIDTH) bits.
//     - Output: Stream of elements, each element of (ACTIVATION_WIDTH) bits.
//
// Dependencies:
//
// Revision:
