...
// Description: This module accepts a stream of elements from 2-D matrices, pads
//     the matrices with zeros, applies a constant 2-D convolution kernel, and
...
module convolve_single_in_single_out #(
    ...
    logic [ACTIVATION_WIDTH-1:0] buffer0_tdata;
    logic buffer0_tlast;
    ...
    logic [ACTIVATION_WIDTH*KERNEL_SIZE*KERNEL_SIZE-1:0] buffer1_tdata;
    logic buffer1_tlast;
