...
proc create_root_design { parentCell } {
  ...
  set swt [ create_bd_port -dir I -from 7 -to 0 swt ]
  ...
  set superresolution_0 [ create_bd_cell -type ip -vlnv ece532.group3.org:ece532:superresolution:1.6 superresolution_0 ]
  set_property -dict [ list \
   CONFIG.Height {1080} \
   CONFIG.Width {1920} \
 ] $superresolution_0
  ...
  connect_bd_net -net swt_1 [get_bd_ports swt] [get_bd_pins axi_gpio_0/gpio_io_i]
