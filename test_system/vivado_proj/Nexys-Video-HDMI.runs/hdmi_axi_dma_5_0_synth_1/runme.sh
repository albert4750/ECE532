...
HD_PWD='/home/ece532/ECE532/test_system/vivado_proj/Nexys-Video-HDMI.runs/hdmi_axi_dma_5_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_axi_dma_5_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hdmi_axi_dma_5_0.tcl
