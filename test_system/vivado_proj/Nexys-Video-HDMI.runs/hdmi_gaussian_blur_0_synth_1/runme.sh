...
HD_PWD='/home/ece532/ECE532/test_system/vivado_proj/Nexys-Video-HDMI.runs/hdmi_gaussian_blur_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_gaussian_blur_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hdmi_gaussian_blur_0.tcl
